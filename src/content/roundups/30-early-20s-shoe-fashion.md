...
# all follow this array. Six shown; the shape is identical for all thirty.
products:
  ...
  - name: Slouchy knee-high boots
    image: ./images/shoe-04.jpg
    alt: Tan slouchy knee-high leather boots
    url: https://www.amazon.com/dp/B0EXAMPLE4

  - name: Strappy block-sandal heels
    note: Block heel, so you can actually stand in them all night.
    image: ./images/shoe-05.jpg
    alt: Nude strappy sandals with a block heel
    url: https://www.amazon.com/dp/B0EXAMPLE5

  - name: Mesh flats with an ankle strap
    image: ./images/shoe-06.jpg
    alt: Black mesh flats with a thin ankle strap
    url: https://www.amazon.com/dp/B0EXAMPLE6
---

Early twenties is when a shoe collection stops being whatever was on sale and
starts being a set of decisions. These thirty cover the ground: something flat
for long days, something with a heel that doesn't punish you, and two pairs of
boots that will still look right in five years.
